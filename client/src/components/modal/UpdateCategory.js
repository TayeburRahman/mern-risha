...
export default function EditModal({ openUpdate, setOpenUpdate,updateData, state, setState}) {
    ...
    const { 
     ...
     axios.put(`http://localhost:6060/api/v1/category/update/${updateData?._id}`,  
        {
            description
        })
          .then(res =>{ 
